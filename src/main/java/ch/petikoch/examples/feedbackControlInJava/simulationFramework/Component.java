...
/**
 * A java port of the Component python class from
 * https://github.com/oreillymedia/feedback_control_for_computer_systems/blob/master/feedback.py
 * <p>
 * This the base interface of all components involved in a feedback control loop.
 * Think of something with an input and an output signal.
 *
